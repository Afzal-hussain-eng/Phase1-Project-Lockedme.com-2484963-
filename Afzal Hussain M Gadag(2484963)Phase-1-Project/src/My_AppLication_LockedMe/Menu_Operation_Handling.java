		...
		do {
			try {
				...
				case 1:
					...
					Business_Level_Operations.create_User_Defined_File(fileToAdd, sc);
				...
				case 2:
					...
					Business_Level_Operations.create_MainFolder_IfNot_Present("LockedMe_main");
					List<String> filesToDelete = Business_Level_Operations.display_File_Locations(fileToDelete, "LockedMe_main");
					...
					if (idx != 0) {
						Business_Level_Operations.delete_User_Defined_Files(filesToDelete.get(idx - 1));
					} else {
						
						// If idx == 0, delete all files displayed for the name
						for (String path : filesToDelete) {
							Business_Level_Operations.delete_User_Defined_Files(path);
						}
					}
				...
				case 3:
					...
					Business_Level_Operations.create_MainFolder_IfNot_Present("LockedMe_main");
					Business_Level_Operations.display_File_Locations(fileName, "LockedMe_main");
